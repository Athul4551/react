...
const handileSubmit = (e) => {
    ...
    return(
        <div>
            <h1>Edit Task</h1>
            <form action="" onSubmit={handileSubmit}>
            Title <input type="text" value={task.title} name="title" onChange={handileChange} id="" className="form-control" />
                Description <input type="text" value={task.description} name="description" onChange={handileChange} id="" className="form-control" />
